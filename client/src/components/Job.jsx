    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100 dark:bg-gray-800 dark:border-gray-700'>
            ...
            <div className='flex items-center gap-2 mt-4'>
                <Badge className={'text-blue-700 font-bold dark:text-blue-300'} variant="ghost">
                    {job?.position} Positions
                </Badge>
                <Badge className={'text-[#F83002] font-bold dark:text-[#F83002]'} variant="ghost">
                    {job?.jobType}
                </Badge>
                <Badge className={'text-[#7209b7] font-bold dark:text-[#7209b7]'} variant="ghost">
                    {job?.salary}LPA
                </Badge>
            </div>
            ...
            <div className='flex items-center gap-4 mt-4'>
                <Button
                    ...
                    variant="outline"
                    className="text-gray-900 dark:text-white dark:border-gray-600"
                >
                    Details
                </Button>
                <Button className="bg-[#7209b7] dark:bg-[#7209b7]">Save For Later</Button>
            </div>
        </div>
    )
}
